...
<style>
    ...
    body .main {
      background-image: url(https://s3-us-west-1.amazonaws.com/dsuploads/wp-content/uploads/2018/07/30091929/code-background.jpg);
    ...
    .sys-upgrade-wrap {
      width: 500px;
      z-index: 9999;
      background: rgba(77, 78, 106, 0.75);
      padding: 30px;
      border-radius: 5px;
      position: absolute;
      top: 50%;
...
<body>
    ...
    <div class="sys-upgrade-wrap">
        ...
        <section class="sys-upgrade-text">
            ...
            <p>We're currenlty preforming scheduled maintenance on our network. Please try again later.</p>

            <footer><a href="javascript:window.location.href=window.location.href">Please click here to reconnect to this website.</a></footer>
        </section>
    </div>
